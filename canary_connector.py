...
class CanaryConnector(BaseConnector):
    ...
    def _handle_is_ip_ignored(self, param):
        ...
        payload = {"src_ip": param["ip_address"]}
    ...
    def _handle_on_poll(self, param):
        ...
        for incident in response["incidents"]:
            ...
            container = {"description": "Container added by Canary API", "run_automation": False}
            container["name"] = incident["summary"]
            container["source_data_identifier"] = incident["id"]
            container["artifacts"] = []
            artifact = {"label": "report", "type": "incident", "name": "incident report", "description": "Artifact added by Canary App"}
            rawFields = {}
            ...
            if len(incident["description"]["events"]) >= 1:
                for event in incident["description"]["events"]:
                    ...
                    artifact = {"label": "report", "type": "incident", "name": "incident event", "description": "Artifact added by Canary App"}
                    artifact["cef"] = event
                    container["artifacts"].append(artifact)
    ...
    def _handle_update_incident(self, param):
        ...
        payload = {"incident": param["incident"]}
